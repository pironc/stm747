...
const Desktop = () => {
  return (
      <div className="mt-8 w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[1.937rem] px-[0.75rem] pb-[4.687rem] box-border gap-[6.437rem] leading-[normal] tracking-[normal] text-left text-[1.5rem] text-black font-inter">
